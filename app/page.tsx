...
import { ArrowRight, FileText, Zap, Users, Globe, Shield, BookOpen, Database, Cpu, Lock, Github, Mail, Phone, CheckCircle2, TrendingUp, BarChart3, Lightbulb, Headphones, Award } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative px-4 md:px-6 py-20 md:py-40 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="relative text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-pretty leading-tight">
          ...
          <div className="flex flex-col md:flex-row gap-3 justify-center mb-12">
            ...
            <Button size="md" variant="outline" className="w-full md:w-auto bg-white">
              Watch Demo Video
            </Button>
          </div>
      ...
      <section id="how-it-works" className="px-4 md:px-6 py-20 bg-gradient-to-b from-blue-50/50 to-white border-y border-border/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-4 backdrop-blur-sm mb-5">
              <Cpu className="w-4 h-4 text-primary" />
              <p className="text-xs text-primary font-semibold">RAG Architecture</p>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">How Arth-Mitra Works</h2>
      ...
      <section id="features" className="px-4 md:px-6 py-20 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-4 backdrop-blur-sm">
      ...
      <section id="testimonials" className="px-4 md:px-6 py-20 bg-gradient-to-b from-blue-50/50 to-white border-t border-b border-border/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-4 backdrop-blur-sm">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">See Arth-Mitra In Action</h2>
      ...
      {/* CTA Section */}
      <section className="px-4 md:px-6 py-20 bg-gradient-to-r from-primary/10 to-accent/10 rounded-3xl max-w-7xl mx-auto mb-10">
      ...
      <footer className="border-t border-border/40 bg-gradient-to-b from-slate-50/50 to-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
          ...
          <div className="border-t border-border/40 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© 2024 Arth-Mitra. All rights reserved. Made with care for Indians.</p>
